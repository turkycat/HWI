...
.. note::
   ...
   **This is a temporary fork of HWI**

   This fork exists because the official HWI repository (https://github.com/bitcoin-core/HWI)
   has not had a release in over a year and is missing key device support required by
   downstream applications. See https://github.com/bitcoin-core/HWI/issues/814 for details.

   Once the official repository produces a new release with the required device support,
   this fork should be deprecated in favor of the official releases.
...
This fork uses GitHub Actions to automate the release process. The workflow is defined
...
This fork uses GitHub Artifact Attestations instead of GPG signing. Attestations provide
...
Official Release Process (Reference)
====================================

The following documents the official release process used by the upstream repository
(https://github.com/bitcoin-core/HWI). This is preserved for reference and may be
useful if contributing changes back upstream.
